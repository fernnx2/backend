 ...
 */
@Stateless
public class DetalleManteniminetoFacade extends AbstractFacade<DetalleMantenimineto> implements DetalleManteniminetoFacadeLocal {
    ...
    public DetalleManteniminetoFacade() {
