 ...
 */
@Stateless
@Path("detallemantenimineto")
public class DetalleManteniminetoFacadeREST extends AbstractFacade<DetalleMantenimineto> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, DetalleMantenimineto entity) {
        super.edit(entity);
    }
    ...
    @Path("{id}")
    @Produces({MediaType.APPLICATION_JSON})
    public DetalleMantenimineto find(@PathParam("id") Integer id) {
    ...
    @Override
    @Produces({MediaType.APPLICATION_JSON})
    public List<DetalleMantenimineto> findAll() {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_JSON})
    public List<DetalleMantenimineto> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
